def get_min_tail_sum(n):
    ...
    is essentially just finding the 'pyramid number' of base n.
    ...
    by calculating the pyramid number of base n. The forumla for pyramid numbers
    is n(n+1)/2.
    """
    return n *(n + 1) / 2
